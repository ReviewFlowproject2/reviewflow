  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <h1 className="font-bold text-3xl text-slate-900 mb-6">Refund Policy</h1>
        <div className="prose text-slate-600">
          <p className="mb-4">Last updated: June 1, 2026</p>
          <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-4">1. Free Trial</h2>
          ...
          <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-4">2. Refund Eligibility</h2>
          ...
          <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-4">3. How to Request a Refund</h2>
          ...
          <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-4">4. Subscription Cancellations</h2>
          ...
          <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-4">5. Exceptions</h2>
