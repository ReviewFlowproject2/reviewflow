...
type TData = {
  ...
  d_qrWrapBg:string; d_qrWrapRadius:number;
  d_qrBorder:string;
  d_qrDark:string; d_qrLight:string;
  d_tagline:string; d_taglineColor:string; d_taglineFont:string;
  d_stars:string; d_starsColor:string;
  cf_bg:string; cf_bgIsGrad:boolean; cf_bg1:string; cf_bg2:string;
  cf_isDark:boolean;
  cf_topBar:string; cf_topBarColor:string;
...
{ id:"classic-blue",name:"Classic Blue",desc:"全科 · 牙科 · 骨科",preview:"/images/qr-previews/preview_style_01_classic_blue.jpg",
  ...
  cf_topBar:null,cf_topBarColor:"",cf_name:"Playfair Display",cf_nameFont:"'Playfair Display',serif",cf_nameColor:"#D4AF37",cf_nameSize:22,
  cf_title:"",cf_titleFont:"",cf_titleColor:"",cf_divider:"#D4AF37",
  cf_contact:"Phone • Website",cf_contactColor:"#D4AF37",cf_contactFont:"'Lato',sans-serif",
  cf_script:"Thank you for trusting us with your smile",cf_scriptFont:"'Dancing Script',cursive",cf_scriptColor:"#D4AF37",cf_corner:"✦",
  cb_bg:"#0A2463",cb_bgIsGrad:true,cb_bg1:"#0A2463",cb_bg2:"#1A3A5C",
  cb_qrDark:"#0A2463",cb_qrLight:"#FFFFFF",cb_qrWrapBg:"#FFFFFF",cb_qrWrapRadius:6,cb_qrBorder:"none",
...
{ id:"mint-green",name:"Mint Green",desc:"儿科 · 医美 · 中医",preview:"/images/qr-previews/preview_style_02_mint_green.jpg",
  ...
  d_qrWrapBg:"transparent",d_qrWrapRadius:6,d_qrBorder:"none",
  d_qrDark:"#2F855A",d_qrLight:"transparent",
  ...
  cf_topBar:"bar",cf_topBarColor:"#6BC4B0",cf_name:"Montserrat",cf_nameFont:"'Montserrat',sans-serif",cf_nameColor:"#2F855A",cf_nameSize:18,
  cf_title:"Pediatric Dentist",cf_titleFont:"'Montserrat',sans-serif",cf_titleColor:"#4CAF50",cf_divider:"",
  cf_contact:"Phone • Email • Web",cf_contactColor:"#666666",cf_contactFont:"'Montserrat',sans-serif",
  cf_script:"",cf_scriptFont:"",cf_scriptColor:"",cf_corner:"",
  cb_bg:"#FFFFFF",cb_bgIsGrad:false,cb_bg1:"#FFFFFF",cb_bg2:"#FFFFFF",
  cb_qrDark:"#2F855A",cb_qrLight:"transparent",cb_qrWrapBg:"transparent",cb_qrWrapRadius:6,cb_qrBorder:"none",
  cb_tagline:"",cb_taglineColor:"",cb_taglineFont:"",cb_stars:"★★★★★",cb_starsColor:"#6BC4B0",cb_corner:"",
},
{ id:"elegant-violet",name:"Elegant Violet",desc:"高端医美 · 整形",preview:"/images/qr-previews/preview_style_03_violet.jpg",
  ...
  d_tagline:"",d_taglineColor:"",d_taglineFont:"",d_stars:"★★★★★",d_starsColor:"#D4AF37",
  cf_bg:"#1A0B2E",cf_bgIsGrad:true,cf_bg1:"#1A0B2E",cf_bg2:"#3D265E",cf_isDark:true,
  cf_topBar:null,cf_topBarColor:"",cf_name:"Playfair Display",cf_nameFont:"'Playfair Display',serif",cf_nameColor:"#D4AF37",cf_nameSize:20,
  cf_title:"",cf_titleFont:"",cf_titleColor:"",cf_divider:"",
  ...
  cb_qrDark:"#1A0B2E",cb_qrLight:"#FFFFFF",cb_qrWrapBg:"#FFFFFF",cb_qrWrapRadius:6,cb_qrBorder:"2px solid #D4AF37",
  cb_tagline:"",cb_taglineColor:"",cb_taglineFont:"",cb_stars:"★★★★★",cb_starsColor:"#D4AF37",cb_corner:"",
},
{ id:"coral-orange",name:"Coral Orange",desc:"家庭诊所 · 理疗",preview:"/images/qr-previews/preview_style_04_coral.jpg",
  ...
  d_qrWrapBg:"#FFFFFF",d_qrWrapRadius:9999,d_qrBorder:"none",
  d_qrDark:"#E07A5F",d_qrLight:"#FFFFFF",
  d_tagline:"",d_taglineColor:"",d_taglineFont:"",d_stars:"★★★★★",d_starsColor:"#FFD54F",
  cf_bg:"#FFFFFF",cf_bgIsGrad:false,cf_bg1:"#FFFFFF",cf_bg2:"#FFFFFF",cf_isDark:false,
  cf_topBar:"bar",cf_topBarColor:"#E07A5F",cf_name:"Montserrat",cf_nameFont:"'Montserrat',sans-serif",cf_nameColor:"#E07A5F",cf_nameSize:18,
  cf_title:"",cf_titleFont:"",cf_titleColor:"",cf_divider:"",
  cf_contact:"Phone • Web",cf_contactColor:"#E07A5F",cf_contactFont:"'Montserrat',sans-serif",
  cf_script:"",cf_scriptFont:"",cf_scriptColor:"",cf_corner:"",
  cb_bg:"#FFFFFF",cb_bgIsGrad:false,cb_bg1:"#FFFFFF",cb_bg2:"#FFFFFF",
  cb_qrDark:"#E07A5F",cb_qrLight:"#FFFFFF",cb_qrWrapBg:"#FFFFFF",cb_qrWrapRadius:6,cb_qrBorder:"none",
...
{ id:"professional-gray",name:"Pro Gray",desc:"科技诊所 · 专科",preview:"/images/qr-previews/preview_style_05_gray.jpg",
  ...
  d_tagline:"",d_taglineColor:"",d_taglineFont:"",d_stars:"☆☆☆☆☆",d_starsColor:"#9CA3AF",
  cf_bg:"#2D2D2D",cf_bgIsGrad:false,cf_bg1:"#2D2D2D",cf_bg2:"#2D2D2D",cf_isDark:true,
  cf_topBar:null,cf_topBarColor:"",cf_name:"Montserrat",cf_nameFont:"'Montserrat',sans-serif",cf_nameColor:"#FFFFFF",cf_nameSize:20,
  cf_title:"",cf_titleFont:"",cf_titleColor:"",cf_divider:"#FFFFFF",
  ...
  cb_qrDark:"#2D2D2D",cb_qrLight:"#FFFFFF",cb_qrWrapBg:"#FFFFFF",cb_qrWrapRadius:6,cb_qrBorder:"none",
  cb_tagline:"",cb_taglineColor:"",cb_taglineFont:"",cb_stars:"★★★★★",cb_starsColor:"#9CA3AF",cb_corner:"",
},
{ id:"forest-green",name:"Forest Green",desc:"中医 · 养生",preview:"/images/qr-previews/preview_style_06_forest.jpg",
  ...
  d_tagline:"",d_taglineColor:"",d_taglineFont:"",d_stars:"★★★★★",d_starsColor:"#3D7A4F",
  cf_bg:"#FAF8F3",cf_bgIsGrad:false,cf_bg1:"#FAF8F3",cf_bg2:"#FAF8F3",cf_isDark:false,
  cf_topBar:"bar",cf_topBarColor:"#8B6F47",cf_name:"Dancing Script",cf_nameFont:"'Dancing Script',cursive",cf_nameColor:"#1B5E20",cf_nameSize:22,
  cf_title:"",cf_titleFont:"",cf_titleColor:"",cf_divider:"",
  cf_contact:"Phone • Web",cf_contactColor:"#1B5E20",cf_contactFont:"'Lato',sans-serif",
  cf_script:"",cf_scriptFont:"",cf_scriptColor:"",cf_corner:"",
  cb_bg:"#FAF8F3",cb_bgIsGrad:false,cb_bg1:"#FAF8F3",cb_bg2:"#FAF8F3",
  cb_qrDark:"#1B5E20",cb_qrLight:"#FFFFFF",cb_qrWrapBg:"#FFFFFF",cb_qrWrapRadius:6,cb_qrBorder:"2px solid #3D7A4F",
  cb_tagline:"",cb_taglineColor:"",cb_taglineFont:"",cb_stars:"★★★★★",cb_starsColor:"#3D7A4F",cb_corner:"",
},
{ id:"luxury-blue-gold",name:"Luxury Gold",desc:"高端私立 · VIP",preview:"/images/qr-previews/preview_style_07_luxury.jpg",
  ...
  cf_topBar:null,cf_topBarColor:"",cf_name:"Great Vibes",cf_nameFont:"'Great Vibes',cursive",cf_nameColor:"#D4AF37",cf_nameSize:24,
  cf_title:"CHIEF PHYSICIAN",cf_titleFont:"'Cormorant Garamond',serif",cf_titleColor:"#D4AF37",cf_divider:"#D4AF37",
  ...
  cb_qrDark:"#0F172A",cb_qrLight:"#FFFFFF",cb_qrWrapBg:"#FFFFFF",cb_qrWrapRadius:6,cb_qrBorder:"1px solid #D4AF37",
  cb_tagline:"",cb_taglineColor:"",cb_taglineFont:"",cb_stars:"★★★★★",cb_starsColor:"#D4AF37",cb_corner:"",
},
];
...
export default function QRCodePage(){
  ...
  return(<div className="min-h-screen bg-gray-50 p-6"><div className="max-w-6xl mx-auto">
    <div className="mb-6"><Link href="/dashboard" className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-teal-600"><ArrowLeft size={16}/>Back to Dashboard</Link></div>
    <div className="flex items-center gap-4 mb-8"><div className="w-12 h-12 rounded-xl bg-teal-50 flex items-center justify-center"><QrCode className="w-6 h-6 text-teal-600"/></div><div><h1 className="font-bold text-2xl text-gray-900">QR Code Generator</h1><p className="text-gray-500 text-sm">7 professional templates — Desk Stand + Business Card (Front & Back)</p></div></div>

    {/* Step 1: Link */}
    <div className="bg-white rounded-2xl border border-gray-200 p-6 mb-6">
      <div className="flex items-center gap-3 mb-4"><span className="w-8 h-8 rounded-full bg-teal-600 text-white flex items-center justify-center text-sm font-bold">1</span><h2 className="font-semibold text-gray-900">Google Review Link</h2></div>
      {!link?(<div>
        <div className="bg-amber-50 rounded-xl border border-amber-200 p-4 mb-4"><div className="flex items-start gap-2"><AlertTriangle className="w-4 h-4 text-amber-500 mt-0.5 shrink-0"/><div><p className="text-sm text-amber-800 font-medium">No review link yet</p><button onClick={()=>setGuide(!guide)} className="text-xs text-amber-700 underline inline-flex items-center gap-1"><HelpCircle size={12}/>How to find {guide?"▲":"▼"}</button>{guide&&<div className="mt-2 text-xs text-amber-700 space-y-1"><p>1. Go to business.google.com → Your Business</p><p>2. Click "Get more reviews" → Copy the short URL</p></div>}</div></div></div>
        <div className="flex gap-2"><input type="url" value={link} onChange={e=>setLink(e.target.value)} placeholder="https://g.page/your-clinic/review" className={`flex-1 ${inputClass}`}/><button onClick={save} disabled={saving||!link.trim()} className="px-5 py-2 bg-teal-600 text-white font-semibold rounded-xl text-sm hover:bg-teal-700 disabled:opacity-50">{saving?"Saving...":"Save & Continue"}</button></div>
      </div>):(<div className="flex items-center justify-between gap-3"><div className="flex-1 flex items-center gap-2 px-3 py-2.5 bg-teal-50 rounded-xl text-sm text-teal-700"><CheckCircle size={14} className="text-green-500 shrink-0"/><span className="truncate">{link}</span></div><button onClick={()=>{navigator.clipboard.writeText(link);setCopy(true);setTimeout(()=>setCopy(false),2000)}} className="p-2 text-gray-400 hover:text-teal-600">{copied?<CheckCircle size={14} className="text-green-500"/>:<Copy size={14}/>}</button><button onClick={()=>setLink("")} className="p-2 text-gray-400 hover:text-red-500"><RefreshCw size={14}/></button></div>)}
    </div>

    {/* Step 2: Template + Info */}
    <div className="bg-white rounded-2xl border border-gray-200 p-6 mb-6">
      <div className="flex items-center gap-3 mb-4"><span className="w-8 h-8 rounded-full bg-teal-600 text-white flex items-center justify-center text-sm font-bold">2</span><h2 className="font-semibold text-gray-900">Choose Template & Business Card Info</h2></div>
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
        {TPL.map(tm=>(<button key={tm.id} onClick={()=>{if(isFree&&tm.id==="luxury-blue-gold")return;setSel(tm.id)}} className={`p-3 rounded-xl border-2 text-left transition-all relative ${sel===tm.id?"border-teal-500 bg-teal-50":isFree&&tm.id==="luxury-blue-gold"?"border-gray-200 opacity-50 cursor-not-allowed":"border-gray-200 hover:border-teal-300"}`}>
          <div className="relative w-full aspect-square rounded-lg mb-2 overflow-hidden bg-gray-100 cursor-pointer" onClick={e=>{e.stopPropagation();setPreview(preview===tm.id?null:tm.id)}}>
          ...
          <div className="flex items-center gap-2"><div className="w-4 h-4 rounded-full border border-gray-300" style={{background:tm.d_bgIsGrad?tm.d_bg1:tm.d_bg}}/><span className="font-medium text-xs text-gray-900">{tm.name}</span></div>
          <p className="text-[10px] text-gray-400 mt-1">{tm.desc}</p>
          {sel===tm.id&&<CheckCircle size={14} className="absolute top-2 right-2 text-teal-600"/>}
        </button>))}
      </div>
      <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
        {[{l:"Clinic Name",v:cname,s:setCname},{l:"Doctor Name",v:dr,s:setDr,ph:"Dr. Smith"},{l:"Card Tagline",v:title,s:setTitle,ph:"Your smile is our priority"},{l:"Phone",v:phone,s:setPhone,ph:"555-123-4567"},{l:"Website",v:web,s:setWeb,ph:"clinic.com"}].map(f=>(<div key={f.l}><label className="text-xs text-gray-500 mb-1 block">{f.l}</label><input value={f.v} onChange={e=>f.s(e.target.value)} placeholder={f.ph||""} className="w-full rounded-lg border border-gray-300 px-2 py-1.5 text-sm text-gray-900"/></div>))}
      </div>
    </div>

    {/* Step 3: Previews */}
    {link&&qrDataUrl&&(<div className="bg-white rounded-2xl border border-gray-200 p-6 mb-6">
      <div className="flex items-center gap-3 mb-6"><span className="w-8 h-8 rounded-full bg-teal-600 text-white flex items-center justify-center text-sm font-bold">3</span><h2 className="font-semibold text-gray-900">Preview & Download</h2></div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 justify-items-center">

        {/* === DESK STAND === */}
        <div className="text-center w-full max-w-[260px]">
          <h3 className="font-semibold text-sm text-gray-900 mb-3">Desk Stand <span className="text-xs text-gray-400 font-normal">5"×5"</span></h3>
          ...
          <button onClick={()=>dl(dRef.current,`desk-stand-${sel}.png`)} className="mt-3 px-4 py-2 bg-teal-600 text-white text-sm font-semibold rounded-lg hover:bg-teal-700 inline-flex items-center gap-2"><Download size={14}/>Download</button>
        </div>

        {/* === CARD FRONT === */}
        <div className="text-center w-full max-w-[260px]">
          <h3 className="font-semibold text-sm text-gray-900 mb-3">Card Front <span className="text-xs text-gray-400 font-normal">3.5"×2"</span></h3>
          ...
          <button onClick={()=>dl(fRef.current,`card-front-${sel}.png`)} className="mt-3 px-4 py-2 bg-teal-600 text-white text-sm font-semibold rounded-lg hover:bg-teal-700 inline-flex items-center gap-2"><Download size={14}/>Download</button>
        </div>

        {/* === CARD BACK === */}
        <div className="text-center w-full max-w-[260px]">
          <h3 className="font-semibold text-sm text-gray-900 mb-3">Card Back <span className="text-xs text-gray-400 font-normal">3.5"×2"</span></h3>
          ...
          <button onClick={()=>dl(bRef.current,`card-back-${sel}.png`)} className="mt-3 px-4 py-2 bg-teal-600 text-white text-sm font-semibold rounded-lg hover:bg-teal-700 inline-flex items-center gap-2"><Download size={14}/>Download</button>
        </div>
      </div>
      <div className="text-center pt-6 mt-6 border-t border-gray-200">
        <button onClick={async()=>{await dl(dRef.current,`desk-stand-${sel}.png`);setTimeout(async()=>{await dl(fRef.current,`card-front-${sel}.png`)},300);setTimeout(async()=>{await dl(bRef.current,`card-back-${sel}.png`)},600)}} className="px-6 py-2.5 border-2 border-teal-600 text-teal-600 font-semibold rounded-xl text-sm hover:bg-teal-600 hover:text-white inline-flex items-center gap-2"><Printer size={14}/>Download All 3</button>
      </div>
    </div>)}
    {link&&<div className="bg-white rounded-2xl border border-gray-200 p-6"><h3 className="font-semibold text-gray-900 text-sm mb-3">Placement Tips</h3><ul className="space-y-2 text-sm text-gray-500"><li>• Desk stand at front desk where patients check out</li><li>• Business cards in waiting room and treatment rooms</li><li>• Include card with receipts for patients who review later</li></ul></div>}
  </div>
  {preview&&<div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onClick={()=>setPreview(null)}><div className="bg-white rounded-2xl p-4 max-w-md mx-4" onClick={e=>e.stopPropagation()}><img src={TPL.find(x=>x.id===preview)?.preview} alt="Preview" className="w-full rounded-xl"/><button onClick={()=>setPreview(null)} className="mt-3 w-full py-2 text-sm font-semibold text-gray-500 hover:text-gray-900">Close</button></div></div>}
  </div>);
}
