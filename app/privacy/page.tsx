  ...
  return (
    <div className="min-h-screen bg-[#F8FAFF]">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <h1 className="font-outfit font-bold text-3xl text-brand-dark mb-6">Privacy Policy</h1>
        <div className="prose text-brand-muted">
          <p className="mb-4">Last updated: June 1, 2026</p>
          <h2 className="text-xl font-semibold text-brand-dark mt-8 mb-4">1. Information We Collect</h2>
          ...
          <h2 className="text-xl font-semibold text-brand-dark mt-8 mb-4">2. How We Use Information</h2>
          ...
          <h2 className="text-xl font-semibold text-brand-dark mt-8 mb-4">3. Data Security</h2>
          ...
          <h2 className="text-xl font-semibold text-brand-dark mt-8 mb-4">4. Third-Party Services</h2>
          ...
          <h2 className="text-xl font-semibold text-brand-dark mt-8 mb-4">5. Your Rights</h2>
