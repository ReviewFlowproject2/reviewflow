  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <h1 className="font-bold text-3xl text-slate-900 mb-6">Terms and Conditions</h1>
        <div className="prose text-slate-600">
          ...
          <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-4">3. Subscription Plans</h2>
          <p className="mb-4">We offer three tiers: Free, Pro ($39/month), and Agency ($69/month). Subscriptions auto-renew unless cancelled. All paid plans include a 15-day free trial.</p>
          ...
          <p className="mb-4">If you are not satisfied within the first 14 days of your paid subscription, contact us for a full refund.</p>
